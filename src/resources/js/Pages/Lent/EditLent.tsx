...
export default function  EditLent(props) {
    ...
    return (
        <Authenticated
            auth={props.auth}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">取り立て情報作成</h2>}
        >
            <Head title="取り立て情報登録" />
            ...
            <form onSubmit={submit}>
                ...
                <div className="mt-4">
                    <Label forInput="email" value="貸主メールアドレス" />
                ...
                <div className="flex items-center justify-end mt-4">
                    <Button className="ml-4 bg-green-600" processing={processing}>
                        取り立てる
                    </Button>
                </div>
            </form>
